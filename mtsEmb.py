...
class embedding_MTS(nn.Module):
    ...
    def __init__(self, config):
        ...
        # self.time_layer = get_torch_trans(heads=8, layers=1, channels=self.emb_size) ## Temporal encoder
        # self.feature_layer = get_torch_trans(heads=8, layers=1, channels=self.emb_size) ## Spatial encoder
